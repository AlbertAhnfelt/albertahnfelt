/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6dd20f6e134724eb3867b63f9dfe71ee)
...
interface __BaseEnv_Env {
	...
	SITE_ORIGIN: string;
	AbbeMCP: DurableObjectNamespace<import("./src/index").AbbeMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AbbeMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_PATH" | "GEMINI_MODEL" | "LETTERBOXD_USERNAME" | "CHESS_USERNAME" | "MCP_AUTH_TOKEN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ALLOWED_EMAILS" | "GEMINI_API_KEY" | "SITE_ORIGIN">> {}
}
